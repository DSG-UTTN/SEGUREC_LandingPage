<?php
/**
 * Mission Vision Component (Placeholder)
 */
?>
...
<div class="section-container">
    ...
    <div class="grid lg:grid-cols-3 gap-8">
        <!-- Misión -->
        <div class="text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300" data-animate="slide-up">
            <div class="w-20 h-20 bg-gold-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg class="w-10 h-10 text-gold-600" fill="currentColor" viewBox="0 0 20 20">
