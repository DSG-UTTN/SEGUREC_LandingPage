        ...
        <div class="relative z-10 section-container text-center">
            <div class="max-w-4xl mx-auto" data-animate="fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center" data-animate="slide-up">
                    <a href="<?= url('contacto') ?>" class="bg-gold-500 text-navy-900 px-8 py-4 rounded-xl font-semibold text-lg text-center hover:bg-gold-400 transition-all shadow-lg flex items-center justify-center group" onclick="return gtagSendEvent('<?= url('contacto') ?>', 'conversion_hero_cotizacion')">
